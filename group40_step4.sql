...
(1, 'Leo', '2018-07-11', 'M', 7, 13.5, 1, 'N', 150, NULL, '2019-08-14', NULL, 4),
(3, 'Luna', '2019-07-16', 'F', 7, 7.5, 4, 'Y', 150, NULL, NULL, NULL, 6),
(5, 'Noodles', '2018-06-07', 'F', 8, 9.8, 6, 'Y', 150, NULL, '2019-09-24', NULL, 5);
...
(1, 'Kobe', 'Bryant', '1234 Wilshire Blvd, Los Angeles, CA, 90036', '(555)555-5554', 'kobe@lakers.com', NULL, NULL),
(5, 'Keanu', 'Reeves', '5678 Hollywood Blvd, Los Angeles, CA, 90210', '(555) 555-5553', 'keanu@johnwick.com', NULL, NULL),
(6, 'Homer', 'Simpson', '742 Evergreen Tr, Springfireld, OR, 97402', '(555) 555- 5552', 'homer@simpsons.com', NULL, NULL);
...
(2, 'Rafi', '2019-04-22', 'M', 14, 40.5, 2, 'Y', 250, NULL, NULL, NULL, 4),
(5, 'Butler', '2018-12-18', 'M', 10, 45, 4, 'Y', 250, NULL, NULL, NULL, 5);
...
(2, 'Joe', 'Shmo', '4321 Wilson St, Eugene, OR, 97402', '(555) 555-8525', 'joe@gmail.com', '2018-11-15', 100, NULL, NULL),
(3, 'Jeff', 'John', '7462 Polk St, Eugene, OR, 97402', '(555) 555-3525', 'jeff@gmail.com', '2019-11-11', 100, NULL, NULL),
(4, 'Jeremy', 'Irons', '7462 Polk St, Eugene, OR, 97402', '(555) 555-1425', 'jeremy@gmail.com', '2017-07-07', 100, NULL, NULL);
...
(4, 0, 'Y', 'Y', NULL, NULL),
(5, 0, 'N', 'Y', 'Respiratory Infections', NULL),
(6, 0, 'N', 'N', NULL, NULL);
...
--
ALTER TABLE `clients_to_cats`
  MODIFY `clients_to_cats_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
